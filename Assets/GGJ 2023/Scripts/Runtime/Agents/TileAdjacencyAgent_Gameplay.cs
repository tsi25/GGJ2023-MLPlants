...
{
    /// <summary>
    /// Version of the TileAdjacencyAgent that has a lot of the manager-type stuff related to training stripped out
    /// </summary>
    public class TileAdjacencyAgent_Gameplay : Agent
    {
